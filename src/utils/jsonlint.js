              ...
              if (typeof t == "undefined" || !t.length || !t[0]) {
                if (!k) {
                  ...
                  this.lexer.showPosition
                    ? (B = "Parse error on line " + (i + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + A.join(", ") + ", got '" + this.terminals_[q] + "'")
                    : (B = "Parse error on line " + (i + 1) + ": Unexpected " + (q == 1 ? "end of input" : "'" + (this.terminals_[q] || q) + "'")),
                    this.parseError(B, { text: this.lexer.match, token: this.terminals_[q] || q, line: this.lexer.yylineno, loc: n, expected: A });
                }
                if (k == 3) {
              ...
              switch (t[0]) {
                ...
                case 2:
                  (y = this.productions_[t[1]][1]),
                    (w.$ = e[e.length - y]),
                    (w._$ = { first_line: f[f.length - (y || 1)].first_line, last_line: f[f.length - 1].last_line, first_column: f[f.length - (y || 1)].first_column, last_column: f[f.length - 1].last_column }),
            ...
            next: function() {
              ...
              if (b) {
                (f = b[0].match(/\n.*/g)),
                  ...
                  (this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: f ? f[f.length - 1].length - 1 : this.yylloc.last_column + b[0].length }),
                  (this.yytext += b[0]),
                  (this.match += b[0]),
